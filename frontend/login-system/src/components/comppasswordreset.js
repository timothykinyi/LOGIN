...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://login-9ebe.onrender.com/api/auth/compresetPassword', formData);
  ...
  return (
    <div className="container">
      ...
      <p>If you remember your password <Link to="/embedlogin">Login</Link></p>
    </div>
  );
};
